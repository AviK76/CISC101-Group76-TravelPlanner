...
1. **Closed Venue**
  ...
  * If a museum or park is closed on that day → suggest a similar type and themed option within 1–2 km; if unavailable, pick a highly rated indoor option.
2. **Over-Budget Meal**
  
  * If meal cost > user’s budget → switch to a cheaper restaurant of similar cuisine.
3. **Buffer Time**

  *Add 15–20 minutes buffer per transfer and 10 minutes per venue setup; if overrun, reduce dwell time or pick nearer alternatives.
